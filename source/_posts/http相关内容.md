...
![img]( http://qiniu.zrbac.fun/1.png )
...
![img]( http://qiniu.zrbac.fun/2.png )

但是也可以分为四层，就是**把链路层和物理层都表示为网络接口层**

![img]( http://qiniu.zrbac.fun/3.png )

还有一种就是 OSI 七层网络模型，它就是在五层协议之上加了**表示层和会话层**

![img]( http://qiniu.zrbac.fun/4.png )
...
![img]( http://qiniu.zrbac.fun/5.png )
...
![img]( http://qiniu.zrbac.fun/6.png )
...
![img]( http://qiniu.zrbac.fun/7.png )
...
![img]( http://qiniu.zrbac.fun/8.png )
...
![img]( http://qiniu.zrbac.fun/9.png )
...
![img]( http://qiniu.zrbac.fun/10.png)

下面为你罗列了一些 TCP 和 UDP 的不同点，方便理解，方便记忆。

![img]( http://qiniu.zrbac.fun/11.png)
...
![img]( http://qiniu.zrbac.fun/12.png)
...
![img]( http://qiniu.zrbac.fun/13.png)
...
![img]( http://qiniu.zrbac.fun/14.png)
...
![img]( http://qiniu.zrbac.fun/15.png)
...
![img]( http://qiniu.zrbac.fun/16.png)
...
![img]( http://qiniu.zrbac.fun/17.png)
...
![img]( http://qiniu.zrbac.fun/18.png)
...
![img]( http://qiniu.zrbac.fun/19.png)
...
![img]( http://qiniu.zrbac.fun/20.png)
...
![img]( http://qiniu.zrbac.fun/21.png)
...
>
> ![img]( http://qiniu.zrbac.fun/22.png)

DNS 是一种分层数据库，它的主要层次结构如下

![img]( http://qiniu.zrbac.fun/23.png)
...
![img]( http://qiniu.zrbac.fun/24.png)
...
![img]( http://qiniu.zrbac.fun/25.png)
